error id: file:///C:/Users/marta/Documents/DOBLE%20GRADO/4º%20carrera/TFG/WEB/TFG/src/main/java/es/marta/tfg/carescan/controller/AdminHospitalController.java:_empty_/PatientDeletionService#
...
empty definition using pc, found symbol in pc: _empty_/PatientDeletionService#
...
public class AdminHospitalController {
    ...
    @Autowired
    private PatientDelet@@ionService patientDeletionService;

    // --------------------------
    // NUEVO: helper para pacientes "seleccionables" (NO INACTIVOS)
    // --------------------------
