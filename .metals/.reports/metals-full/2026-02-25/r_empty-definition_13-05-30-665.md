error id: file:///C:/Users/marta/Documents/DOBLE%20GRADO/4º%20carrera/TFG/WEB/TFG/src/main/java/es/marta/tfg/carescan/controller/MedicoController.java:_empty_/Consulta#getUser#
...
empty definition using pc, found symbol in pc: _empty_/Consulta#getUser#
...
public class MedicoController {
    ...
    public String publishResult(@PathVariable Long consultaId, Authentication auth) {
        ...
        if (!consulta.getU@@ser().getId().equals(doctor.getId())) {
            return "redirect:/access-denied";
        }
